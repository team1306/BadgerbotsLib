...
public class TankDriveOld
{
	...
	public TankDriveOld(Jaguar leftJag, Jaguar rightJag, Joystick leftJoy, Joystick rightJoy)
	{
		_square = false;
		_leftJag = leftJag;
		_rightJag = rightJag;
	...
	public TankDriveOld(int leftChan, int rightChan, Joystick leftJoy, Joystick rightJoy)
	{
	...
	public TankDriveOld(Jaguar l, Jaguar r)
	{
		_leftJag = l;
		_rightJag = r;
	}

	public TankDriveOld(int leftChan, int rightChan, int leftPort, int rightPort)
	{
		_leftJag = new Jaguar(leftChan);
		_rightJag = new Jaguar(rightChan);
